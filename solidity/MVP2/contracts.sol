...
contract Work {
    ...
    function Work(
        ...
        imageUrl = _imageUrl;
        logger.logWorkReleased(_title, _artist);
    }
}

// "0xdc544654fefd1a458eb24064a6c958b14e579154", "0xcca417069d356fcf870f4fe05b7d95bf700de960", 1, "ipfs://audio", "ipfs://metadata", [], [], ["0x1234", "0x1235"], [1, 2]
contract PayPerPlay {
    ...
    // proportional payments (dependent on coinsPerPlay or tip size)
    ...
    function play() {
        ...
        distributePayment(coinsPerPlay, true);
     ...
     */
    function updateLicense(uint _coinsPerPlay, 
        ...
        if (totalRoyaltyAmounts > coinsPerPlay) 
            throw;
